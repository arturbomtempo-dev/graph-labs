...
export const documentation: AlgorithmDocumentation[] = [
    ...
    {
        id: 'dijkstra',
        idea: 'Resolve o problema de caminhos mínimos de origem única. A cada iteração seleciona o vértice não visitado u com a menor estimativa de caminho mais curto a partir de s, marca-o como visitado e relaxa todas as arestas (u, x) com x ∈ Adj[u].',
        pseudocode: [
            'Dijkstra(G, w, s)',
        ...
        invariant:
            'Para todo u ∈ S, d[u] já é o peso do caminho mínimo de s até u. Ao final, d[ ] guarda os pesos dos caminhos mínimos — os caminhos em si são recuperados pela lista de predecessores π[ ].',
        pitfalls: [
            'Usar Dijkstra com aresta de peso negativo: exige w : E → ℝ⁺. Reponderar somando uma constante a todas as arestas também falha.',
            'Reinserir em Q um vértice que já pertence a S.',
            'Achar que d[ ] devolve os caminhos: sem π[ ] só se obtêm os pesos.',
        ],
    },
    {
        id: 'bellman-ford',
